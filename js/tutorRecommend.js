...
$(document).ready(function() {
    ...
    $(window).scroll(function() {
        ...
        if(windowUp >= calculate) {
            ...
            $(icon1).attr("src",_PATH+'/resources/fiveAdvantages/tutorRecommend/1b.png');
            ...
            $(".section1 .subTitle").css("color","#4b91cf");
        //} else if ((windowUp < calculate) && (windowUp >= (calculate - 50))) {
            ...
            $(icon1).attr("src",_PATH+'/resources/fiveAdvantages/tutorRecommend/1g.png');
            $(".section1 .subTitle").css("color","black");
        }
        if (windowUp >= outSection1) {
            $(icon2).css({"transform":"rotateY(180deg)","transition-duration":"0.5s"});
            $(icon2).attr("src",_PATH+'/resources/fiveAdvantages/tutorRecommend/2b.png');
            if($(window).width() >= 1024) {
                $(img2).stop().animate({
                    left: "60px",
                    opacity: 1
            ...
            $(".section2 .subTitle").css("color","#4b91cf");
        } else {
            $(icon2).css({"transform":"rotateY(360deg)","transition-duration":"0.5s"});
            $(icon2).attr("src",_PATH+'/resources/fiveAdvantages/tutorRecommend/2g.png');
            if($(Window).width() >=1024) {
                $(img2).stop().animate({
                    left: "0px",
                    opacity: 0.6
